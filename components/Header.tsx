        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <div className="relative">
            <button
              ...
              className="relative p-2.5 rounded-xl hover:bg-forest-100 transition-all duration-200 hover:scale-105"
            >
            ...
            {showNotifications && (
              <>
                ...
                />
                <div className="absolute right-0 mt-3 w-80 sm:w-96 bg-white rounded-2xl shadow-2xl border border-forest-200/50 z-50 overflow-hidden animate-scale-in">
                  {/* Header */}
                  <div className="p-5 border-b border-forest-100 bg-gradient-to-r from-bank-50 via-white to-bank-50">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-bold text-forest-900 text-lg">
                          Notifications
                        </h3>
                      ...
                      <button className="p-2 rounded-lg hover:bg-forest-100 transition-colors">
                        <X
                  ...
                  <div className="max-h-96 overflow-y-auto">
                    {notifications.map((notification, index) => (
                      <div
                        key={notification.id}
                        className={`p-4 hover:bg-forest-50/50 transition-colors cursor-pointer ${
                          index !== notifications.length - 1
                            ? "border-b border-forest-50"
                            : ""
                        }`}
                      >
                  ...
                  {/* Footer */}
                  <div className="p-3 bg-forest-50/50 border-t border-forest-100">
                    <button className="w-full py-2.5 text-center text-sm font-semibold text-bank-600 hover:text-bank-700 hover:bg-bank-50 rounded-lg transition-colors">
